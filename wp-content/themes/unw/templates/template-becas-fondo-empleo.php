...
/**
 * Template Name: Becas Fondo Empleo
 */
?>
  ...
  <div class="main_container">
    <div class="info_page">
      <div class="cover_img_page center">
        ...
        <img src="<?= UPLOAD_MIGRATION_PATH . '/becas-fondo-empleo/1920x400_becas-fondo-empleo.jpg' ?>" srcset="<?= UPLOAD_MIGRATION_PATH . '/becas-fondo-empleo/500x250_becas-fondo-empleo.jpg' ?> 500w, <?= UPLOAD_MIGRATION_PATH . '/becas-fondo-empleo/1920x400_becas-fondo-empleo.jpg' ?> 1920w" sizes="100vw" alt="" class="img_cover">
        <div class="info_cover_page center">
          <div id="presenta_vf" class="container">
            <h2 class="categoria_page serv_uni">Becas Externas</h2>
            <h1 class="h1_carreras medium">Becas Fondo Empleo</h1>
          </div>
        </div>
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga">
              ...
              <a href="#" aria-current="page" class="link miga w--current">Becas Fondo Empleo</a>
            </div>
          </div>
        </div>
      ...
      <div class="main_page">
        <div class="page_interna">
          <div class="container full">
            <div class="_2-col">
              <div class="col-1 centrosuniversitarios full">
                    ...
                    <div class="content_seccion_tab">
                      <div class="info_section">
                        ...
                        <div class="contenido-becas">
                          <p>FONDOEMPLEO, o Fondo Nacional de Capacitación Laboral y Promoción del Empleo, es una entidad privada sin fines de lucro en Perú. Su objetivo principal es promover el empleo decente, especialmente entre poblaciones vulnerables, mediante la capacitación laboral, formación profesional y financiamiento de proyectos que generen empleo o aumenten ingresos. Para conocer las convocatorias vigentes deberá revisar la web de <a href="https://fondoempleo.com.pe/nosotros/" target="_blank" rel="noopener">Fondo Empleo.</a></p>
                        </div>
