  ...
  <div class="main_container">
    <div class="info_page">
      <div class="cover_img_page center">
        ...
        <img src="<?= UPLOAD_MIGRATION_PATH . '/constancia-promedio-ponderado/libro_reclamaciones.jpg' ?>"
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga"><a href="/" class="link miga">Inicio /</a><a
                href="<?= home_url("/servicios-universitarios/registros-academicos/") ?>" class="link miga ">Registros
                Académicos&nbsp;/</a><a href="#" aria-current="page" class="link miga w--current">Usuario clave</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="_2-col">
              <div class="col-1 full">
                <div class="tabs_menu notab serv_uni">
                  <a href="#sec-1" data-w-id="3ef52d6c-1954-6cc6-c293-604099689d68"
                    class="link_item_tab w-inline-block">
                    <div>Presentación</div>
                  </a>
                  <a href="#sec-2" data-w-id="3ef52d6c-1954-6cc6-c293-604099689d6b"
                    class="link_item_tab w-inline-block">
                    <div>¿Cuáles son los requisitos que debo cumplir?</div>
                  </a>
                  <a href="#sec-3" data-w-id="3ef52d6c-1954-6cc6-c293-604099689d6e"
                    class="link_item_tab w-inline-block">
                          ...
                          <div class="clase_para_wordpress richt_text">
                            ...
                            <div class="content_section">
                              <div class="w-richtext">
                                <p>Trámite mediante el cual el alumno solicita su usuario y la clave de acceso A
                                  Wienernet y/o runachay.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="wrapper_collection mt auto w-dyn-list">
                          <div role="list" class="collection_list gilla _3-col registrosacademicos w-dyn-items">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-promedio-ponderado/") ?>"
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/duplicado-de-record-de-notas-historico/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-estudios/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-horas-por-curso/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/historial-academico/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/certificado-de-estudios-por-ciclo/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/modificacion-de-sus-datos-en-el-sistema-y-o-foto/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/traslado-interno/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/usuario-clave/") ?>"
                                class="item_serv_university w-inline-block w--current">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/reserva-de-matricula-2/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/reserva-de-matricula/") ?>"
                                class="item_serv_university w-inline-block ">
                                <h4 class="h4_light">Reserva de matrícula</h4>
                                <div class="btn-legacy text">Ver más</div>
                              </a>
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/anulacion-de-matricula/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/retiro-de-cursos/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/certificacion-de-aprendizaje-habilidades-y-conocimiento-ingles-informatica/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-ingreso/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/record-de-notas/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/plan-de-estudios/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-quinto-superior/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-tercio-superior/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-para-estudiante-del-exterior/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/constancia-de-matricula/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/tramite-para-realizar-el-proceso-de-sustentacion-parte-ii/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/duplicado-carne-universitario/") ?>"
                                class="item_serv_university w-inline-block ">
                            ...
                            <div role="listitem" class="collection_item serv_univer w-dyn-item">
                              <a href="<?= home_url("/registros-academicos/carne-de-medio-pasaje/") ?>"
                                class="item_serv_university w-inline-block ">
