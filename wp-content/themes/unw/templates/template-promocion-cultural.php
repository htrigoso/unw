...
/**
 * Template Name: Promoción Cultural
 */
?>
      ...
      <div class="cover_img_page center">
        ...
        <div class="info_cover_page center">
          <div id="presenta_vf" class="container">
            ...
            <h1 class="h1_carreras medium">Promoción Cultural</h1>
          </div>
        </div>
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga">
              ...
              <a href="#" aria-current="page" class="link miga w--current">Promoción Cultural</a>
            </div>
          </div>
        </div>
            ...
            <div class="_2-col">
              <div class="col-1 full">
                <div class="tabs_menu notab serv_uni secretaria ">
                  <a href="#presenta_vf" class="link_item_tab w-inline-block">
                    <div>Presentación</div>
                  </a>
                  <a href="#horarios_vf" class="link_item_tab w-inline-block">
                    ...
                    <div class="content_seccion_tab">
                      <div class="info_section">
                        ...
                        <div class="contenido-becas">
                          <h3>Presentación</h3>
                          <p>El área de Promoción Cultural promueve y fomenta el desarrollo cultural y artístico de la comunidad universitaria, a través de los siguientes talleres y elencos:</p>
                          <div class="box_list">
                            <div class="richt_text prfmargintop marginright w-richtext">
                              <h5><strong>Talleres</strong></h5>
                              <ul role="list">
                                <li>Danzas afroperuanas</li>
                            ...
                            <div class="richt_text prfmargintop marginright w-richtext">
                              <h5><strong>‍Elencos</strong></h5>
                              <ul role="list">
                                <li>Danzas</li>
                                <li>Teatro</li>
                                <li>Tuna universitaria</li>
                                <li>Cajón peruano</li>
                                <li>Marinera norteña</li>
                              </ul>
                            </div>
                            <!-- <div class="richt_text prfmargintop marginright w-richtext">
                                ...
                                <ul role="list">
                                  <li>Básquetbol</li>
                                  <li>Futsal (Damas–Varones)</li>
                                  <li>Vóleibol mixto</li>
                                  <li>Karate</li>
                                </ul>
                              </div>
                              <div class="richt_text prfmargintop w-richtext">
                                <h5>‍<strong>Selecciones</strong></h5>
                                <ul role="list">
                                  <li><strong>‍</strong>Básquetbol (Damas – Varones)<br/></li>
                                  <li>Futsal (Damas – Varones)</li>
                                  <li>Vóleibol (Damas – Varones)</li>
                                  <li>Karate</li>
                                </ul>
                              </div> -->
                          </div>
                        ...
                        <div class="content_section">
                          <a href="https://intranet.uwiener.edu.pe/sso.asp" target="_blank" class="btn-legacy w-button">Ver Horarios<br></a>
