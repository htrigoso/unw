...
/**
 * Template Name: Constancia de grado académico, titulo profesional u otros
 */
?>
      ...
      <div class="cover_img_page center">
        ...
        <div class="info_cover_page center">
          <div id="sec-1" class="container">
            ...
            <h1 class="h1_carreras">Constancia de grado académico, título profesional u otros</h1>
          </div>
        </div>
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga"><a href="/" class="link miga">Inicio /</a><a href="https://www.uwiener.edu.pe/servicios-universitarios/secretaria-general/" class="link miga ">Secretaria General&nbsp;/</a><a href="#" aria-current="page" class="link miga w--current">Constancia de grado académico, título profesional u otros</a></div>
          </div>
        </div>
      </div>
      <div class="main_page">
            ...
            <div class="_2-col">
              <div class="col-1 top_fixed">
                <div class="tabs_menu notab serv_uni">
                  ...
                  <a href="#sec-2" data-w-id="6ebc11f9-0aa8-9fc3-cafc-45c06e87b880" class="link_item_tab scroll large anipo w-inline-block w--current"><img src="https://www.uwiener.edu.pe/wp-content/themes/uwienerwp/assets/images/icon_current_tab.svg" data-w-id="aaa77376-6de4-f84b-771a-e855515f4f03" style="opacity: 0;" alt="" class="point_anima">
                      ...
                      <div class="info_section full">
                        <div id="section_one" class="content_section mt paddingright">
                          <div class="clase_para_wordpress richt_text">
                            <h2>Presentación</h2>
                            <p><br></p>
                            <p>Es el documento oficial que acredita que la persona solicitante obtuvo el Grado Académico de Bachiller, Título Profesional u otros en nuestra Universidad.</p>
                          </div>
                        </div>
                        ...
                        <div id="section_faq" class="content_section">
                          ...
                          <div class="wrapper_collection mt auto w-dyn-list">
                            <div role="list" class="collection_list gilla _3-col w-dyn-items">
                              ...
                              <div role="listitem" class="collection_item serv_univer w-dyn-item">
                                <a href="https://www.uwiener.edu.pe/secretaria-general/constancia-de-grado-academico-titulo-profesional-u-otros/" class="item_serv_university w-inline-block w--current">
