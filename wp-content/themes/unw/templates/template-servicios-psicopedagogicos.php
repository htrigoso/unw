...
/**
 * Template Name: Servicios Psicopedagógicos
 */
?>
      ...
      <div class="cover_img_page center">
        ...
        <div class="info_cover_page center">
          <div id="presenta_vf" class="container">
            ...
            <h1 class="h1_carreras medium">Servicios psicopedagógicos</h1>
          </div>
        </div>
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga">
              ...
              <a href="#" aria-current="page" class="link miga w--current">Servicios psicopedagógicos</a>
            </div>
          </div>
        </div>
                    ...
                    <div class="content_seccion_tab">
                      <div class="info_section">
                        ...
                        <div class="contenido-becas">
                          <h2>Presentación</h2>
                          <p><br></p>
                          <p>Promueven y fomentan la salud psicológica y emocional en la comunidad universitaria.</p>
                          <p><br></p>
                          <ul>
                            <li><span style="color: #33cccc;">Orientación y consejería psicológica</span><br>
                              Atención a problemas emocionales como ansiedad, estrés, problemas de pareja, entre otros.</li>
                            <li><span style="color: #33cccc;"><span style="color: #33cccc;">Orientación y consejería psicopedagógica<br>
                                  <span style="color: #333333;">Atención a problemas académicos como problemas de aprendizaje, concentración, etc.&nbsp;</span></span></span></li>
                            <li><span style="color: #33cccc;">Programa LIDERA<br>
                                <span style="color: #333333;">Talleres psicopedagógicos y psicológicos.<br>
                                </span></span>-Taller: “Mi plan de vida, un camino al éxito”<br>
                              -Taller: “¿Cómo potenciar la motivación en mis estudios?”<br>
                              -Taller: “La autovaloración, una herramienta valiosa”<br>
                              -Taller: “Manejo de mis emociones”<br>
                              -Taller: “Mi proyecto de vida”<br>
                              -Taller: “Fortaleciendo mis hábitos de estudio”<br>
                              -Entre otros…</li>
                          </ul>
                          <h4 class="h4_verde"><strong>Horario de atención&nbsp;</strong></h4>
                          <p><br></p>
                          <table class="aligncenter" style="height: 145px; border-color: #07c8cc;" border="3" width="970" cellspacing="5" cellpadding="6">
                            <tbody>
                              <tr>
                                <td>&nbsp; &nbsp; &nbsp;Local</td>
                                <td style="text-align: center;">Lunes</td>
                                <td style="text-align: center;">Martes</td>
                                <td style="text-align: center;">Miércoles</td>
                              ...
                              <tr>
                                ...
                                <td style="text-align: center;">&nbsp;9:00 am – 6:00 pm</td>
                                <td>&nbsp; &nbsp;9:00 am – 6:00 pm</td>
                                <td style="text-align: center;">&nbsp;9:00 am – 6:00 pm</td>
                                <td>&nbsp; &nbsp;9:00 am – 6:00 pm</td>
                              </tr>
                          ...
                          <p><br></p>
                          <p class="p1">Refrigerio 13:00 pm -14:00 pm hrs</p>
                          <p>*El horario puede cambiar durante el año. Si deseas una cita, escribir a <a href="servicios.psicopedagogicos@uwiener.edu.pe">servicios.psicopedagogicos@uwiener.edu.pe</a></p>
                        </div>
                          ...
                          <div class="contact_box">
                            ...
                            <div class="item_user_contacto informes">
                              <div class="item_contact"><img src="<?= UPLOAD_MIGRATION_PATH . '/shared/arroba_black.svg' ?>" alt="" class="icon_contact">
                                <div>servicios.psicopedagogicos@uwiener.edu.pe</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="content_section">
                          <div class="legal marrgintop">WienerNet: Servicios adicionales &gt; Bienestar universitario &gt; Servicios al estudiante &gt; Servicios psicopedagógicos </div>
                        </div>
                      </div>
                    </div>
                  </div>
