  ...
  <div class="main_container">
    ...
    <div class="info_page">
      <div class="cover_img_page center">
        ...
        <img
          src="https://www.uwiener.edu.pe/wp-content/uploads/2020/09/empleabilidad-y-Relacionamiento-Empresarial-1.png"
          srcset="https://www.uwiener.edu.pe/wp-content/uploads/2020/09/empleabilidad-y-Relacionamiento-Empresarial500.png 500w, https://www.uwiener.edu.pe/wp-content/uploads/2020/09/empleabilidad-y-Relacionamiento-Empresarial-1.png 1920w"
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga"><a href="https://www.uwiener.edu.pe/" class="link miga">Inicio /</a><a
                ...
                universitarios&nbsp;/</a><a href="#" aria-current="page" class="link miga w--current">Dirección de
                Empleabilidad y Alumni</a></div>
          </div>
        </div>
      </div>
      <div class="main_page">
                ...
                <div class="info_content_tab full-right">
                      ...
                      <div class="info_section full">
                        ...
                        <div class="clase_para_wordpress richt_text">
                          ...
                          <ul>
                            ...
                            <li>Egresados de Pregrado Wiener de todas las carreras.</li>
                          ...
                          <p style="text-align: justify;">El objetivo de la Dirección de Empleabilidad
                            y&nbsp;Alumni&nbsp;es brindar&nbsp;<b>herramientas y oportunidades de
                              desarrollo&nbsp;</b>profesional, para&nbsp;<b>nuestros estudiantes y
                          ...
                          <ul>
                            <li style="text-align: justify;">Impulsar el crecimiento personal y profesional de nuestra
                              comunidad estudiantil y alumni Wiener.</li>
                          </ul>
                          <ul style="text-align: justify;">
                            <li><span lang="es">Brindar atención y acompañamiento especializado en temas de
                                empleabilidad a los estudiantes y egresados Wiener.</span></li>
                          </ul>
                          <ul style="text-align: justify;">
                            <li><span lang="es">Desarrollar soluciones de aprendizaje basadas en investigación,
                                habilidades blandas y perfiles laborales actuales, para el avance profesional de nuestra
                                comunidad.</span></li>
                          </ul>
                          <ul style="text-align: justify;">
                            <li><span lang="es">Responder satisfactoriamente a las necesidades de los estudiantes y
                                egresados, generando un plan de acción orientado a brindar herramientas de inserción
                                laboral y el desarrollo de habilidades de empleabilidad, así como un plan de búsqueda de
                                trabajo, que fomente un empleo formal con puestos laborales afines a su carrera de
                                estudios.</span></li>
                          </ul>
                          <ul>
                            <li style="text-align: justify;"><span lang="es">Gestionar sinergias y alianzas estratégicas
                          ...
                          <ul>
                            ...
                            <li><strong><span lang="es">Difusión de la oportunidad laboral entre nuestros estudiantes y
                                  egresados (según sea el requerimiento)</span></strong></li>
                            <li><strong><span lang="es">Pre filtrar los&nbsp;CVs&nbsp;recepcionados&nbsp;y compartir con
                                  la empresa aquellas que se ajusten a sus necesidades.</span></strong></li>
                            <li><strong><span lang="es">Realizar el seguimiento del proceso, a fin de conocer la
                                  contratación de alguno de nuestros postulantes.</span></strong></li>
                          </ul>
                          <p><br></p>
                          <p style="text-align: justify;"><span lang="es">Si deseas que te apoyemos con la difusión de
                              un vacante laboral en tu empresa, escríbenos a:&nbsp;</span><a id="LPlnk833448"
                              href="mailto:empleabilidad@uwiener.edu.pe" target="_blank" rel="noopener noreferrer"
                              data-auth="NotApplicable" data-loopstyle="link" data-safelink="true" data-linkindex="0"
                              title="empleabilidad@uwiener.edu.pe"><span
                      ...
                      <div id="conocemas" class="content_section pr w-condition-invisiblex">
                        ...
                        <div class="btn_box">
                          <a href="https://bolsalaboral.uwiener.edu.pe/" target="_blank"
                            ...
                            <img
                              src="https://assets.website-files.com/5e14b299ed73794253b5000e/5e44401df7be1240e1ab20d7_icon_bt.svg"
                  ...
                  <div class="contact_box contact">
                    ...
                    <div class="item_user_contacto">
                      ...
                      <div class="contact_cargo"></div>
                      <div class="item_contact">
                        <img src="https://www.uwiener.edu.pe/wp-content/themes/uwienerwp/assets/images/icon_pnone.svg"
                          alt="" class="icon_contact">
                        <div>Telf. 706-5555 anexos 3211- 3234</div>
                      </div>
                      <div class="item_contact last">
                        <img src="https://www.uwiener.edu.pe/wp-content/themes/uwienerwp/assets/images/icon_mail.svg"
                          alt="" class="icon_contact">
                        <div>empleabilidad@uwiener.edu.pe</div>
                      </div>
                    </div>

                    <div class="item_user_contacto ">
                      <h4 class="h4_verde"><strong>Horario de atención:</strong><br></h4>
                      <div class="text-maxwidth">Lunes y viernes: De 09:00 – 18:00</div>
                    </div>
                  </div>
                </div>
              </div>
