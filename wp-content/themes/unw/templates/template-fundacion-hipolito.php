      ...
      <div class="cover_img_page center">
        ...
        <div class="info_cover_page center">
          <div id="presenta_vf" class="container">
            ...
            <h1 class="h1_carreras medium">Fundación Hipólito Unanue – FIHU</h1>
          </div>
        </div>
        ...
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga">
              ...
              <a href="#" aria-current="page" class="link miga w--current">Fundación Hipólito Unanue – FIHU</a>
            </div>
          </div>
        </div>
                    ...
                    <div class="content_seccion_tab">
                      <div class="info_section">
                        ...
                        <div class="contenido-becas">
                          <p>La Fundación Instituto Hipólito Unanue es una institución creada en el año 1967 por la Asociación Nacional de Laboratorios Farmacéuticos, ALAFARPE, con la finalidad de promover la investigación, enseñanza y divulgación científica en el campo de las profesiones médicas y estimular el perfeccionamiento de éstas.</p>
                          <p>Sus fines son promover el estudio, la enseñanza, investigación y divulgación de las Ciencias Médicas en el país, realizar actividades asistenciales y de auxilio en beneficio de la Comunidad.</p>
                          <p><a href="https://www.fihu.org.pe/quienes-somos/" target="_blank" rel="noopener">Quienes Somos – Fundación Instituto Hipólito Unanue.</a></p>
                        </div>
