  ...
  <div class="main_container">
    <div class="info_page">
      <div class="cover_img_page center">
        ...
        <img src="<?= UPLOAD_MIGRATION_PATH . '/becas/jefatura-de-becas.jpg' ?>"
          srcset="<?= UPLOAD_MIGRATION_PATH . '/becas/jefatura-de-becas.jpg' ?> 500w, <?= UPLOAD_MIGRATION_PATH . '/becas/jefatura-de-becas.jpg' ?> 1920w"
                      ...
                      <div class="info_section full">
                        <div class="content_section">
                          ...
                          <div class="contenido-becas">
                            ...
                            <ul>
                              <li><a
                                  href="<?= UPLOAD_MIGRATION_PATH . '/becas/Resolucion-PE-029-2025-RPE-UPNW-2-2.pdf' ?>"
