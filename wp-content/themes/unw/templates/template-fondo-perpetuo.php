...
/**
 * Template Name: Fondo Perpetuo para la Educación - ASPERSUD
 */
?>
  ...
  <div class="main_container">
    <div class="info_page">
      <div class="cover_img_page center">
        ...
        <img src="https://www.uwiener.edu.pe/wp-content/uploads/2025/07/1920x400_fondo-perpetuo-para-la-educacion-aspersud.jpg" srcset="https://www.uwiener.edu.pe/wp-content/uploads/2025/07/500x250_fondo-perpetuo-para-la-educacion-aspersud.jpg 500w, https://www.uwiener.edu.pe/wp-content/uploads/2025/07/1920x400_fondo-perpetuo-para-la-educacion-aspersud.jpg 1920w" sizes="100vw" alt="" class="img_cover">
        <div class="info_cover_page center">
          <div id="presenta_vf" class="container">
            <h2 class="categoria_page serv_uni">Becas Externas</h2>
            <h1 class="h1_carreras medium">Fondo Perpetuo para la Educación – ASPERSUD</h1>
          </div>
        </div>
                    ...
                    <div class="content_seccion_tab">
                      <div class="info_section">
                        ...
                        <div class="contenido-becas">
                          <p>El Fondo Perpetuo para la Educación (FPE) es un programa de fondos rotativos promovido por La Iglesia de Jesucristo de los Santos de los Últimos Días. Su objetivo es apoyar económicamente a miembros mayores de 18 años que sean dignos, necesiten ayuda y estén comprometidos con su autosuficiencia. Se otorgan préstamos accesibles para capacitación técnica, vocacional o incluso profesional, siempre orientada a empleos con alta demanda local.</p>
                          <p>Para más información sobre el proceso de postulación y requisitos, te invitamos a visitar el sitio web de <a href="https://www.churchofjesuschrist.org/life/education/perpetual-education-fund?lang=spa" target="_blank" rel="noopener">Fondo Perpetuo para la Educación – ASPERSUD.</a></p>
                        </div>
