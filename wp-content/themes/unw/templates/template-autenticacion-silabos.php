...
/**
 * Template Name: Autenticación de Sílabos
 */
?>
      ...
      <div class="cover_img_page center">
        ...
        <div class="info_cover_page center">
          <div id="sec-1" class="container">
            ...
            <h1 class="h1_carreras">Autenticación de sílabos</h1>
          </div>
        </div>
        <div class="miga_de_pan">
          <div class="container">
            <div class="content_links_miga"><a href="/" class="link miga">Inicio /</a><a href="https://www.uwiener.edu.pe/servicios-universitarios/secretaria-general/" class="link miga ">Secretaria General&nbsp;/</a><a href="#" aria-current="page" class="link miga w--current">Autenticación de sílabos</a></div>
          </div>
        </div>
      </div>
      <div class="main_page">
                      ...
                      <div class="info_section full">
                        <div id="section_one" class="content_section mt paddingright">
                          <div class="clase_para_wordpress richt_text">
                            <h2>Presentación</h2>
                            <p><br></p>
                            <p>Es el proceso que certifica que el sílabo original fue expedido por la Universidad.</p>
                          </div>
                        </div>
                        <div id="sec-2" class="content_section mt paddingright">
                          <div class="richt_text w-richtext">
                            ...
                            <div class="clase_para_wordpress richt_text">
                              <ul>
                                <li>Sílabos originales con el sello del Director de Programa Académico</li>
                          ...
                          <div class="w-dyn-list">
                            <div role="list" class="w-dyn-items">
                              ...
                              <div role="listitem" class="w-dyn-item">
                                <div class="acordeon">
                                  <div class="trigger_acordeon">
                                    <h4 class="h4_faq">¿Por qué demora tanto la entrega del duplicado?</h4>
                                  ...
                                  <div class="content_acordeon" style="height: 0px;">
                                    <div class="content_section">
                                      <div class="w-richtext">
                                        <p>Porque depende del volumen de los documentos que se gestionan diariamente.</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div role="listitem" class="w-dyn-item">
                                <div class="acordeon">
                                  <div class="trigger_acordeon">
                                    <h4 class="h4_faq">¿Por qué cuesta S/1.00 por cara?</h4>
                                    <div class="icon_box"><img src="<?= UPLOAD_MIGRATION_PATH . '/shared/select.svg' ?>" alt="" class="arrow_down"></div>
                                  </div>
                                  <div class="content_acordeon" style="height: 0px;">
                                    <div class="content_section">
                                      <div class="w-richtext">
                                        <p>Es la tarifa fijada en el cronograma de pagos.</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div role="listitem" class="w-dyn-item">
                                <div class="acordeon">
                                  <div class="trigger_acordeon">
                                    <h4 class="h4_faq">¿Por qué lo tiene que sellar el Programa Académico?</h4>
                                    <div class="icon_box"><img src="<?= UPLOAD_MIGRATION_PATH . '/shared/select.svg' ?>" alt="" class="arrow_down"></div>
                                  </div>
                                  <div class="content_acordeon" style="height: 0px;">
                                    <div class="content_section">
                                      <div class="w-richtext">
                                        <p>Porque el Programa Académico tiene los planes curriculares; el Secretario General certifica la firma de la autoridad del Programa Académico.</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div id="section_faq" class="content_section">
                          ...
                          <div class="wrapper_collection mt auto w-dyn-list">
                            <div role="list" class="collection_list gilla _3-col w-dyn-items">
                              ...
                              <div role="listitem" class="collection_item serv_univer w-dyn-item">
                                <a href="https://www.uwiener.edu.pe/secretaria-general/autenticacion-de-silabos/" class="item_serv_university w-inline-block w--current">
