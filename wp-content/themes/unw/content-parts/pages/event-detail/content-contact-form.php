<form id="form" class="contact-form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data"
  action="https://forms.zohopublic.com/adminzoho11/form/WienerFestFebrero2024PADIN/formperma/ZbdRB4sXjKQwrUlVka73M3EpeCzwBaEPB7tIlb5Eei4/htmlRecords/submit">
  ...
  <input type="hidden" name="utm_source" value="eventos_internos">
  <input type="hidden" name="utm_medium" value="web">
  <input type="hidden" name="utm_campaign" value="wiener_fest_20261">
  <input type="hidden" name="utm_term" value="set_2025">
  <input type="hidden" name="utm_content" value="1">
      ...
      <div class="form-field form-field-select">
        <select name="Dropdown100" id="documentType" type="text" required>
          ...
          <optgroup label="Ciencias de la Salud">
            ...
            <option value="5985073000000969096" data-campus="63-64">Tecnología Médica en Terapia Física y Rehabilitación
            </option>
            <option value="5985073000000969095" data-campus="63-64">Tecnología Médica en Laboratorio Clínico y Anatomía
              Patológica</option>
          ...
          <optgroup label="Negocios">
            ...
            <option value="5985073000000969085" data-campus="63">Administración y Negocios Internacionales</option>
        ...
        <label for="document">Escoge tu carrera</label>
        <span class="error-message">Datos inválidos</span>
      </div>

      <div class="form-field form-field-select">
        <select name="selec_sedes" id="documentType" type="text" required>
          <option value="-Select-" disabled>Escoge tu grado</option>
