  ...
  <div class="x-container x-container--pad-213 pba-testimonials__wrapper">
    ...
    <div class="pba-testimonials-cards">
      <?php foreach ($testimonials as $i => $testimonial) : ?>
        <div class="pba-testimonial-card">
          <img src="<?php echo $testimonial['image']; ?>" alt="" aria-hidden="true" class="pba-testimonial-card__image">
          <div class="pba-testimonial-card__content"<?php if ($i === 1) { echo ' data-variant="asu"'; } ?>>
            <p class="pba-testimonial-card__content--quote"><?php echo $testimonial['quote']; ?></p>
            <p class="pba-testimonial-card__content--author line-clamp-1"><?php echo $testimonial['author']; ?></p>
            <p class="pba-testimonial-card__content--position"><?php echo $testimonial['position']; ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
