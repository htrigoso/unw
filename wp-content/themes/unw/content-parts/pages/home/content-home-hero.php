        ...
        ?>
          <div class="swiper-slide swiper-hero__slide">
            <?php if (!empty($slide['type'])): ?>
              ...
              ?>
              <a href="<?php echo $final_href; ?>" <?php echo $data_attr; ?> target="<?php echo esc_attr($link_simple_target); ?>" aria-label="<?php echo esc_attr($link_simple['title'] ?? 'Ver más'); ?>">
                <picture class="swiper-hero__picture">
                  <source srcset="<?php echo esc_url($img_desktop_url); ?>" width="1920" height="754" media="(min-width: 768px)" />
                  <img alt="<?php echo esc_attr($img_mobile_alt); ?>" src="<?php echo esc_url($img_mobile_url); ?>" class="swiper-hero__picture--img" width="768" height="500" fetchpriority="high" decoding="async" loading="eager" />
                </picture>
              </a>
            <?php else:
            ?>
                  ...
                  <article class="hero__content">
                    ...
                    <?php if (!empty($link_one) || !empty($link_two)): ?>
                      <div class="hero__content--buttons">
                        ...
                        ?>
                          <a class="btn btn-primary hero__content--cta" href="<?php echo $href_one; ?>" <?php echo $data_attr_one; ?> target="<?php echo esc_attr($link_one['target'] ?: '_self'); ?>">
                        ...
                        ?>
                          <a class="btn btn-primary-outline hero__content--cta" href="<?php echo $href_two; ?>" <?php echo $data_attr_two; ?> target="<?php echo esc_attr($link_two['target'] ?: '_self'); ?>">
