...
/* HTTPS Support */
// Get site URL from environment variables or use default
define('WP_HOME', getenv('WP_HOME') ? getenv('WP_HOME') : 'https://unw.seekqa.com');
define('WP_SITEURL', getenv('WP_SITEURL') ? getenv('WP_SITEURL') : 'https://unw.seekqa.com');
$_SERVER['HTTPS'] = 'on';
